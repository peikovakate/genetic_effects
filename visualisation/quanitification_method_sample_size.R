...
sample_size %>% write_tsv("visualisation/sample_sizes.tsv")

#################################
sample_size = readr::read_tsv("visualisation/sample_sizes.tsv")
datasets = readr::read_tsv("../data2/gtex/dataset_significant_qtls.tsv")
